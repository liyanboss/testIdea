...
CREATE TABLE `currency_exchange_rate` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=11279 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=712 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_history` (
  ...
  KEY `ix_player_history_starttime` (`START_TIME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `player_history_ex`
--

DROP TABLE IF EXISTS `player_history_ex`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `player_history_ex` (
  `PLAYER_HISTORY_ID` bigint(20) NOT NULL,
  `PLAYER_PLATFORM` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `TABLE_CASH_CURRENCY` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `TABLE_EXCHANGE_RATE_FROM_RMB` decimal(19,6) DEFAULT NULL,
  `PLAYER_BET_AMOUNT_IN_RMB` decimal(19,6) DEFAULT NULL,
  `PLAYER_WIN_FROM_POT_IN_RMB` decimal(19,6) DEFAULT NULL,
  `PLAYER_WIN_LOSE_IN_RMB` decimal(19,6) DEFAULT NULL,
  `PLAYER_COLLECTED_RAKE_IN_RMB` decimal(19,6) DEFAULT NULL,
  `PLAYER_EXCHANGE_RATE_FROM_RMB` decimal(19,6) DEFAULT NULL,
  `START_TIME` datetime DEFAULT NULL,
  `END_TIME` datetime DEFAULT NULL,
  PRIMARY KEY (`PLAYER_HISTORY_ID`),
  KEY `ix_player_history_ex_starttime` (`START_TIME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `table_history_ex`
--

DROP TABLE IF EXISTS `table_history_ex`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `table_history_ex` (
  `TABLE_HISTORY_ID` bigint(20) NOT NULL,
  `TABLE_CASH_CURRENCY` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `TABLE_EXCHANGE_RATE_FROM_RMB` decimal(19,6) DEFAULT NULL,
  `TABLE_TOTAL_POT_IN_RMB` decimal(19,6) DEFAULT NULL,
  `TABLE_COLLECTED_RAKE_IN_RMB` decimal(19,6) DEFAULT NULL,
  `START_TIME` datetime DEFAULT NULL,
  `END_TIME` datetime DEFAULT NULL,
  PRIMARY KEY (`TABLE_HISTORY_ID`),
  KEY `ix_table_history_ex_2` (`START_TIME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tabletype` (
  ...
  `CASH_CURRENCY` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `transactionrecord` (
  ...
  KEY `ix_transactionrecord_2` (`REQUEST_TIME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-08-20 11:25:37
