...
#sudo nohup java -Xms1G -Xmx1G -Djdk.xml.entityExpansionLimit=0 -Djava.net.preferIPv4Stack=true -classpath ".:/pkmj/lobbyserver/running/*" com.pkmj.lobby.LobbyServerLauncher > /pkmj/lobbyserver/logs/nohup_lobby.out &
sudo sleep 3s
