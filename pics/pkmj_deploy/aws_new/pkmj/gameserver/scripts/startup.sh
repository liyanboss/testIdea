...
#sudo nohup java -Xms1G -Xmx1G -Djdk.xml.entityExpansionLimit=0 -Djava.net.preferIPv4Stack=true -classpath ".:/pkmj/gameserver/running/*" com.pkmj.game.GameServerLauncher > /pkmj/gameserver/logs/nohup_game.out &
sudo sleep 3s
