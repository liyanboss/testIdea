...
sudo /pkmj/airobot_tlmn/scripts/startup.sh
...
sudo /pkmj/airobot_rmin/scripts/startup.sh
echo '------------------------- airobot_rmin startup done -------------------------'
sudo /pkmj/airobot_ddzb/scripts/startup.sh
echo '------------------------- airobot_ddzb startup done -------------------------'
sudo /pkmj/airobot_big2/scripts/startup.sh
