...
sudo nohup java -Xms2G -Xmx2G -Djdk.xml.entityExpansionLimit=0 -Djava.util.secureRandomSeed=true -Dlogback.configurationFile="/pkmj/gameserver/running/logback.xml" -classpath ".:/pkmj/gameserver/running/*" com.pkmj.game.GameServerLauncher > /pkmj/gameserver/logs/nohup_game.out &
