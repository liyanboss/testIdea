...
sudo nohup java -Xms1G -Xmx1G -Djdk.xml.entityExpansionLimit=0 -Dlogback.configurationFile="$ai_robot_home/running/logback.xml" -classpath ".:$ai_robot_home/running/*" com.pkmj.robot.main.AiRobotLauncher > "$ai_robot_home"/logs/nohup_airobot.out &
sudo sleep 3s
