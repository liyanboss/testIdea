#!/bin/sh
echo sudo /pkmj/airobot_niuniu/scripts/shutdown.sh
echo '------------------------- airobot_niuniu shutdown done -------------------------'
echo sudo /pkmj/airobot_dmqq/scripts/shutdown.sh
echo '------------------------- airobot_dmqq shutdown done -------------------------'
echo sudo /pkmj/airobot_txhd/scripts/shutdown.sh
echo '------------------------- airobot_txhd shutdown done -------------------------'
echo sudo /pkmj/airobot_tlmn/scripts/shutdown.sh
echo '------------------------- airobot_tlmn shutdown done -------------------------'
echo sudo /pkmj/airobot_pkdn/scripts/shutdown.sh
echo '------------------------- airobot_pkdn shutdown done -------------------------'
echo sudo /pkmj/airobot_bcmn/scripts/shutdown.sh
echo '------------------------- airobot_bcmn shutdown done -------------------------'
echo sudo /pkmj/airobot_ggth/scripts/shutdown.sh
...
sudo /pkmj/airobot_fish/scripts/shutdown.sh
echo '------------------------- airobot_fish shutdown done -------------------------'
