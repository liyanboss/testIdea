#!/bin/sh
echo sudo /pkmj/airobot_niuniu/scripts/startup.sh
echo '------------------------- airobot_niuniu startup done -------------------------'
echo sudo /pkmj/airobot_dmqq/scripts/startup.sh
echo '------------------------- airobot_dmqq startup done -------------------------'
echo sudo /pkmj/airobot_txhd/scripts/startup.sh
echo '------------------------- airobot_txhd startup done -------------------------'
echo sudo /pkmj/airobot_tlmn/scripts/startup.sh
echo '------------------------- airobot_tlmn startup done -------------------------'
echo sudo /pkmj/airobot_pkdn/scripts/startup.sh
echo '------------------------- airobot_pkdn startup done -------------------------'
echo sudo /pkmj/airobot_bcmn/scripts/startup.sh
echo '------------------------- airobot_bcmn startup done -------------------------'
echo sudo /pkmj/airobot_ggth/scripts/startup.sh
...
sudo /pkmj/airobot_fish/scripts/startup.sh
echo '------------------------- airobot_fish startup done -------------------------'
